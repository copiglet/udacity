...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    nd_img = np.flip((inference/np.max(inference))*0xff).T.astype(np.uint8)
    # This is how you create a PIL image from numpy array
    pil_i = Image.fromarray(nd_img, mode="L").convert("RGBA").resize(512)
...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"/home/phenomx/dante/udacity/Applying_AI_to_3D_Medical_Imaging_Data/test_sections/nd320-c3-3d-imaging-starter/section2/out/2022-05-09_0813_Basic_unet/model.pth")
    ...
    report_save_path = r"/home/phenomx/dante/udacity/Applying_AI_to_3D_Medical_Imaging_Data/test_sections/nd320-c3-3d-imaging-starter/section3/out"
